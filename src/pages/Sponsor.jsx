...
export default function Sponsorship() {
  ...
  const tiers = {
    ...
    Diamond: {
      ...
      benefits: [
        "<strong>Brand Visibility:</strong> Logo on seminar program and select marketing materials.",
        "<strong>Advertising Flyers:</strong> Distribution of 250 flyers to attendees.",
    ...
    Gold: {
      ...
      benefits: [
        "<strong>Brand Visibility:</strong> Logo on the seminar program.",
        "<strong>Advertising Flyers:</strong> Distribution of 100 flyers to attendees.",
        "<strong>Access:</strong> Direct access to all seminar attendees.",
        "<strong>Complimentary Registrations:</strong> 3 delegate passes.",
        "<strong>Recognition:</strong> Acknowledgment during the seminar and on social media.",
      ],
    },
    Silver: {
      ...
      benefits: [
        "<strong>Brand Visibility:</strong> Logo on seminar banners and website.",
        "<strong>Recognition:</strong> Mention in promotional materials.",
